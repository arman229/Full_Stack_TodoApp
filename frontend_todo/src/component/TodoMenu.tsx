...
const TodoMenu: React.FC<todomenutype> = ({ onEditItem, onDeleteItem }) => {
  ...
  return (
    <div className="relative inline-block text-left">
      ...
      <div
        ref={todoMenuRef}
        className={`menu origin-top-right absolute right-0 mt-1.5 w-24 rounded-lg shadow-lg  bg-gray-300 dark:bg-gray-700   ${
          isMenuOpen ? "block" : "hidden"
        }`}
      >
        <div className="py-1 ">
          <div
            className=" cursor-pointer block px-4 py-2 text-sm  text-black bg-gray-300 hover:bg-gray-400    dark:text-white dark:bg-gray-700 dark:hover:bg-[#091319] "
