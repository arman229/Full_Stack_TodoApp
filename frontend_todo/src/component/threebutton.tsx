...
const ThreeChips: React.FC<ThreeChipsProps> = ({
  selectedChip,
  onSelectChip,
}) => {
  ...
  return (
    <div className="p-8    flex justify-center">
      <div
        className={`inline-flex p-2 sm:px-3 items-center rounded-lg transition duration-300 ease-in-out cursor-pointer 
  ${
    selectedChip === "all"
      ...
      <div
        className={`inline-flex  mx-2 p-2 sm:px-3 items-center rounded-lg transition duration-300 ease-in-out cursor-pointer 
  ${
