...
const AddTodoModel: FC<AddTodoModelInterface> = ({
  isDarkMode,
  closeModal,
  onSave,
  editTodoItem,
  ...
  return (
    <>
      <div
        onClick={closeModal}
        className="fixed inset-0 opacity-70  bg-black"
      ></div>
      <div
        style={{ transform: "translateY(-50%)" }}
        className={`rounded-xl  fixed  top-[50%]  shadow-md  p-4 w-full max-w-md max-h-full ${
          isDarkMode ? " bg-white " : "bg-gray-900 text-white"
        } `}
      >
        ...
        <form>
          <div className="mb-4">
            <label
              ...
              className={`block text-sm font-medium  ${
                isDarkMode ? " bg-white text-gray-900 " : "  text-white"
              }`}
            >
              {" "}
              Title:{" "}
            ...
            <input
              ...
              className={`mt-1 p-2 w-full border rounded-md  ${
                isDarkMode ? " bg-white   " : "bg-gray-700 text-white"
              }`}
              value={title}
          ...
          <div className=" flex gap-2 mb-4">
            ...
            <div style={{ flex: "1" }}>
              ...
              <select
                ...
                className={`mt-1 p-2 block w-full border rounded-md shadow-sm text-black  focus:outline-none focus:ring focus:border-blue-300 ${
                  isDarkMode
                    ? " bg-white text-gray-900 "
                    : "   bg-gray-700 text-white"
                }`}
          ...
          <div className={`mb-4 `}>
            ...
            >
              {" "}
              Lables (Press Enter to add multiple){" "}
            </label>
            <input
              type="text"
              id="tags"
          ...
          <div className="  flex  items-center    ">
            ...
            <label
              htmlFor="comments"
              className={`text-sm leading-6 font-medium text-black  px-2 ${
          ...
          >
            <button
              type="button"
              onClick={closeModal}
              className={`text-gray-500 bg-gray-300 hover:bg-gray-400 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 ${
            ...
            <button
              onClick={onSubmit}
              type="button"
              className={` ms-3 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center  `}
            >
              {" "}
              Add Todo{" "}
            </button>
